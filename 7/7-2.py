...
# 切分训练集和测试集
X_train, X_test, y_train, y_test = train_test_split(data_dum.iloc[:, 1:], data_dum.iloc[:, 0], test_size=.1,
                                                    random_state=520)
lr = LogisticRegression(max_iter=500)  # 建立LR模型
